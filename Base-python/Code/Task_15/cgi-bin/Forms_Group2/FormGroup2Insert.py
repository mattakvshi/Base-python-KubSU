...
def insertData(con):
    ...
    if surnameListener == "-default-" or nameListener == "-default-" or patronymicListener == "-default-" or idListener == "-default-":
        ...
        cursorObj.execute("INSERT INTO Group2(SurnameListener, NameListener, PatronymicListener, IdListener) VALUES(?, ?, ?, ?)", temp_list)
...
<html lang = "ru">
    ...
    <body>
        ...
        <div class = "buttonWrapper">
            ...
            <a href = "http://localhost:8080/Forms_Group2/FormGroup2Insert.html"><button>Вставить данные ещё раз</button></a>
            <a href = "http://localhost:8080/Forms_Group2/FormGroup2Change.html"><button>Изменить данные</button></a>
        </div>
    </body>
</html>"""
