...
def changeData(con):
    ...
    if id != "-default-" and surnameListener != "-default-" and nameListener != "-default-" and patronymicListener != "-default-" and idListener != "-default-":
        ...
        temp_list.append(id)
        cursorObj.execute(
            "UPDATE Group4 SET SurnameListener = ?, NameListener = ?, PatronymicListener = ?, IdSubject = ? WHERE Id = ?",
            temp_list)
        ...
        cursorObj.execute("DELETE FROM Group4 WHERE Id = ?", (id,))
    ...
    <body>
        ...
        <div>
            ...
            <div class = "buttonWrapper">
                ...
                <a href = "http://localhost:8080/Forms_Group4/FormGroup4Change.html"><button>Изменить данные ещё раз</button></a>
                <a href = "http://localhost:8080/Forms_Group4/FormGroup4Insert.html"><button>Вставить данные</button></a>
            </div>
        </div>
    </body>
</html>"""
