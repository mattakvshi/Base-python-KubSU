...
def changeData(con):
    ...
    if id != "-default-" and surnameListener != "-default-" and nameListener != "-default-" and patronymicListener != "-default-" and idListener != "-default-":
        ...
        temp_list.append(id)
        cursorObj.execute(
            "UPDATE Group3 SET SurnameListener = ?, NameListener = ?, PatronymicListener = ?, IdSubject = ? WHERE Id = ?",
            temp_list)
        ...
        cursorObj.execute("DELETE FROM Group3 WHERE Id = ?", (id,))
    ...
    <body>
        ...
        <div>
            ...
            <div class = "buttonWrapper">
                ...
                <a href = "http://localhost:8080/Forms_Group3/FormGroup3Show.html"><button>Показать данные</button></a>
                <a href = "http://localhost:8080/Forms_Group3/FormGroup3Change.html"><button>Изменить данные ещё раз</button></a>
                <a href = "http://localhost:8080/Forms_Group3/FormGroup3Insert.html"><button>Вставить данные</button></a>
            </div>
        </div>
    </body>
</html>"""
